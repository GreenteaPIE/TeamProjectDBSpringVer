...
<div class="frame user-frm">
	<article class="card-body" style="max-width: 700px; margin: auto;">
		...
		<span class="final_name_ck">이름을 입력해주세요.</span>
				<div class="form-group input-group fg-x700">
					...
					<input name="name" class="form-control user_input"
						placeholder="이름 입력" type="text" required />

					<div class="btn-group" date-toggle="buttons">
						<label class="btn  active" style="background-color: #D9D9D9;">
							<input type="radio" name="gender" autocomplete="off" value="1"
							checked>남자
						</label> <label class="btn "
							style="color: #737272; background-color: #D9D9D9;"> <input
 ...
 <span class="final_id_ck">아이디를 입력해주세요.</span>
				<div class="form-group input-group fg-x700">
					...
					<input id="userid" name="userid" class="form-control id_input"
					placeholder="ID 입력" type="text" required />
				</div>
...
<div class="mail_check_wrap">
    <div class="form-group input-group fg-x700">
        ...
        <div class="mail_check_button">
            <input type="button" class="btn btn-primary" value="인증번호 전송">
        </div>
    </div>
    ...
    <span id="mail_check_input_box_warn"></span>
			...
			<div class="form-group input-group fg-x700">
				...
				<input id="phone" name="phone" class="form-control"
					placeholder="휴대폰번호 입력('-' 제외)" type="text" required />
			</div>
			<!-- form-group// -->
			...
			<div class="form-group input-group fg-x700">
				...
				<input type="text" id="address1" class="form-control address_input_1" name="address1"
					placeholder="우편번호" readonly="readonly" /> <br />
				<div class="form-group input-group fg-x700">

					<input type="text" id="address2" class="form-control address_input_2"
						name="address2" placeholder="주소" readonly="readonly" />
				</div>
				<br /> <input type="text" id="address3" class="form-control address_input_3"
					name="address3" placeholder="상세주소" /> <br /> 
					<input type="button" onclick="execution_daum_address()" class="rbutton xsmall white btn btn-primary" value="우편번호 찾기"> <br>
			</div>
			...
			<div class="fg-x700 form-group">
				<input type="button" class="btn btn-primary btn-block join_button"
					value="가입하기">
			</div>
			<!-- form-group// -->
			<p class="text-center">
