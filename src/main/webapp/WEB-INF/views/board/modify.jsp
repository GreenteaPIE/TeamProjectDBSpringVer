		...
		<form id="modifyForm" action="/board/modify" name="frm" method="post">
			...
			<div class="row">
				<table class="table" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td>작성자 <input type="text" class="form-control" name="userid" value='<c:out value="${pageInfo.userid}"/>'></td>
						</tr>
						<tr>
							<td>제목 <input type="text" class="form-control" name="title" value='<c:out value="${pageInfo.title}"/>'></td>
						</tr>
						<tr>
			...
			<div style="display: flex; justify-content: space-between;">
				<div style="margin-left: 30px;">
					<input id="modify_btn" type="button" class="btn btn-primary" value="등록"> &nbsp;&nbsp; &nbsp;&nbsp; <input id="list_btn" type="button" class="btn btn-primary" value="목록">
				</div>
				<div>
